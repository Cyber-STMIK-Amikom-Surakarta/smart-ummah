export default function Kursus() {
  ...
  <div class=" w-full px-[90px] justify-around items-center pb-8 flex flex-row">
    ...
    <div class="w-full px-[90px] flex justify-around ">
      ...
      href="#">
      <img src="https://images.pexels.com/photos/7129612/pexels-photo-7129612.jpeg" class="shadow rounded-lg overflow-hidden border" />
      <div class=" p-4">
      ...
      <div class="mt-4">
          <h4 class="font-bold text-xl text-[#5D5A88]">Ilmu Tajwid</h4>
          <p class="mt-2 text-[#3F3F3F]">Dirancang khusus untuk membantu Anda memahami dan menguasai kaidah-kaidah bacaan Al-Qur'an dengan benar.
          </p>
          <div class="mt-4">
  ...
  <a class="p-8 max-w-lg  bg-white border border-gray-200 rounded-lg shadow flex flex-col items-center"
      href="#">
      <img src="https://images.pexels.com/photos/7129392/pexels-photo-7129392.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="shadow rounded-lg overflow-hidden border" />
      <div class=" p-4">
